...
Best used for **larger** tournaments that happen less frequently, like monthlies, regionals, etc.
  - [ingest_startgg.py](https://github.com/davisdude/startgg-scripts/blob/master/scripts/ingest_startgg.py) can be used to attached the resulting VODs to start.gg.
